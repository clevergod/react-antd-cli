...
var FilterMenu = function (_React$Component) {
    ...
    FilterMenu.prototype.render = function render() {
        ...
        return _react2["default"].createElement(
            _dropdown2["default"],
            { trigger: ['click'], overlay: menus, visible: this.neverShown ? false : this.state.visible, onVisibleChange: this.onVisibleChange, getPopupContainer: function getPopupContainer(triggerNode) {
